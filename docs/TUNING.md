...
python3 tools/tune.py --port /dev/ttyACM0
python3 tools/tune.py --tests CA      # just axis accel + axis speed
python3 tools/tune.py --fine          # small steps from current values
```
